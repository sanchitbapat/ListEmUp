 ...
 * @see SystemUiHider
 */
public class ViewPricesActivity extends Activity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button list=(Button)findViewById(R.id.dummy_button1);
        list.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(ViewPricesActivity.this, HotItemsActivity.class));
            }
            ...
            public void done(List<ParseObject> itemList, ParseException e) {
                if (e == null) {
                    for (int i = 0; i < itemList.size(); i++) {
                        ...
                        s+=p.getString("Location")+"\t"+p.getString("Name")+"\t"+p.getString("Price")+"\n";
